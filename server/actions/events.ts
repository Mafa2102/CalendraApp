...
export async function createEvent(
    ...
    try {
      ...
      await db.insert(EventTable).values({ ...data, durationInMinutes: data.durationInMinutes.toString(), clerkUserId: userId })
...
export async function updateEvent(
    ...
    try {
      ...
      const { rowCount } = await db
        .update(EventTable)
        .set({ ...data, durationInMinutes: data.durationInMinutes.toString(), }) // Update with validated data
